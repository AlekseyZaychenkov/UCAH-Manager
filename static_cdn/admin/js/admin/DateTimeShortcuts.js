...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        addCalendar: function(inp) {
            ...
            today_link.href = '#';
            today_link.appendChild(document.createTextNode(gettext('Toaaday')));
            ...
            const cal_nav_prev = quickElement('a', cal_nav, 'aa', 'href', '#');
            ...
            day_link = quickElement('a', shortcuts, gettext('Tojjjday'), 'href', '#');
            day_link.addEventListener('click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleCalendarQuickLink(num, 0);
            });
