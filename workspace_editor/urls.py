...
urlpatterns = [
    ...
    path('workspace?workspace_id=<int:workspace_id>?post_edit_id=<str:post_id>', home, name="workspace_by_id_post_edit_by_id"),
    path('workspace?workspace_id=<int:workspace_id>?post_delete_id=<str:post_id>', home, name="workspace_by_id_post_delete_by_id"),
    ...
    path('downloading?workspace_id=<int:workspace_id>?post_edit_id=<str:post_id>', downloading, name="downloading_workspace_by_id_post_edit_by_id"),
    path('downloading?workspace_id=<int:workspace_id>?post_delete_id=<str:post_id>', downloading, name="downloading_workspace_by_id_post_delete_by_id"),
